...
public class PO_AddView extends PO_View {
	static public void fillForm(WebDriver driver, String nombreAgentep, String passwordAgentep, String tipoAgentep,
			String namep, String descriptionp, String tagsp, String propertiesp) {
